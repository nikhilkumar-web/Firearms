    ...
    <main className="bg-[#FFFFFF] text-[#000000] overflow-x-hidden font-roboto">
      ...
      >
        ...
        <div className="relative z-10 max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 
            className="text-[22px] sm:text-[50px] font-semibold uppercase text-white leading-[26px] sm:leading-[60px]"
            style={{ fontFamily: "'Gabarito', sans-serif" }}
          >
            CONTACT US
          </h1>
          <h2 
            className="text-[20px] sm:text-[28px] md:text-[32px] font-semibold uppercase text-white leading-[26px] sm:leading-[34px] md:leading-[38px] mt-2 sm:mt-3"
            style={{ fontFamily: "'Gabarito', sans-serif" }}
          >
      ...
      {/* 2. MAIN CONTENT SECTION (Elementor 7602af6) */}
      <section className="py-[30px] sm:py-[50px] px-3 sm:px-6 lg:px-8">
        <div className="max-w-[1300px] mx-auto flex flex-col lg:flex-row gap-[20px] items-start">
          
          {/* LEFT COLUMN: Icon Box + Contact Form + Map (Elementor 4162ce8 - 64.153%) */}
          <div 
          ...
          >
            ...
            {/* Contact Form 7 Grid (Elementor d496ffd) */}
              ...
              {submitted ? (
                <div className="p-8 text-center bg-[#f7faf7] border border-green-200 rounded-[10px] my-6">
                  ...
                  <button
                    ...
                    className="mt-5 px-6 py-2.5 bg-black text-white text-sm font-semibold rounded-[5px] hover:bg-zinc-800 transition-colors"
                  >
            ...
            {/* Google Maps Embed (Elementor e7aacaf / 7811658) */}
            <div 
          ...
          {/* RIGHT COLUMN: Subscribe to YouTube Channel (Elementor d4d1ca4 - 35.77%) */}
          <div 
          ...
          >
            ...
            {/* Subscribe Button (Elementor 3fe3177) */}
